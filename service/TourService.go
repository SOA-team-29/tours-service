...
func (service *TourService) SetTourCharacteristics(tourID int, characteristics []model.TourCharacteristic) error {
	err := service.TourRepo.SetTourCharacteristics(tourID, characteristics)
	if err != nil {
		return err
	}
	return nil
